...
// RegisterGreetServiceHandler registers the http handlers for service GreetService to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "GreetServiceClient".
...
var (
	pattern_GreetService_Greet_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "example", "echo"}, ""))
)
